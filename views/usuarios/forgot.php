			...
			<div class="card forgot-box">
				<div class="card-body">
					<div class="p-4 rounded  border">
						...
						<h4 class="mt-5 font-weight-bold">Restaura tu Password?</h4>
						<p class="text-muted">Enter your registered email ID to reset the password</p>
						<div class="my-4">
							<label class="form-label">Correo Electrónico</label>
							<input type="email" class="form-control form-control-lg" id="correo" placeholder="it.soporte.facturacion@outlook.com" autocomplete="off" />
						</div>
