...
<body>
        ...
        <tr>
            ...
            <td class="info-compra">
                <div class="container-factura">
                    <span class="factura"><strong>NOTA DE VENTA</strong></span>
    ...
    <table id="container-producto">
        ...
        <tbody>
            ...
            <?php } ?>
            <tr class="total">
                <td class="text-right" colspan="3">SubTotal Bs</td>
                <td class="text-right"><?php echo number_format($subTotal, 2); ?></td>
            </tr>
            
            <tr class="total">
                <td class="text-right" colspan="3">Total con Descuento Bs</td>
                <td class="text-right"><?php echo number_format($totalSD, 2); ?></td>
            </tr>
            <tr class="total">
                <td class="text-right" colspan="3">Total sin Descuento Bs</td>
