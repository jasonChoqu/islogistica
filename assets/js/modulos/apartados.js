...
document.addEventListener('DOMContentLoaded', function () {
  ...
  btnAccion.addEventListener('click', function () {
    ...
    if (filas < 2) {
      ...
      alertaPersonalizada('warning', 'FECHA APARTADO ES REQUERIDO');
      return;
    } else if (fecha_retiro.value == '') {
      alertaPersonalizada('warning', 'FECHA RETIRO ES REQUERIDO');
      return;
    } else if (abono.value == '') {
      alertaPersonalizada('warning', 'ABONO ES REQUERIDO');
      return;
    } else {
