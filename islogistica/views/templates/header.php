...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <!--navigation-->
            <ul class="metismenu" id="menu"data-toggle="metismenu">
  <li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Ventas</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Ventas por Vendedor</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Ventas por Clientes</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Ventas por Categoria</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Apartados</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Creditos</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Compras</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Compras por Proveedor</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Stock General</a>
                        </li>
                        <li> <a href="<?php echo BASE_URL . '#'; ?>"><i class="bx bx-right-arrow-alt"></i>Reporte de Movimientos de Caja por Vendedor</a>
                        </li>
